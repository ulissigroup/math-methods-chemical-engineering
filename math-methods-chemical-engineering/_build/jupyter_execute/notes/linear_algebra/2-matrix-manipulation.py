...
# 
# This is an engineering course. The math and homeworks will be difficult and challenging. I am expecting that they will take you on average about 8 hours per week to do (+ 4 hours in class, for a 12 credit class) including studying. If you find that they are taking you substantially longer to do, please let me know and we can discuss strategies. 
...
# * [Basic python syntax](https://colab.research.google.com/github/jakevdp/WhirlwindTourOfPython/blob/master/02-Basic-Python-Syntax.ipynb)
# * [Variables in python](https://colab.research.google.com/github/jakevdp/WhirlwindTourOfPython/blob/master/03-Semantics-Variables.ipynb)
# * [Data structures in python](https://colab.research.google.com/github/jakevdp/WhirlwindTourOfPython/blob/master/06-Built-in-Data-Structures.ipynb])
# * [Importing modules in python](https://colab.research.google.com/github/jakevdp/WhirlwindTourOfPython/blob/master/13-Modules-and-Packages.ipynb)
# * [Intro to numpy](https://colab.research.google.com/github/jakevdp/PythonDataScienceHandbook/blob/master/notebooks/02.02-The-Basics-Of-NumPy-Arrays.ipynb)
