...
# <a href="https://colab.research.google.com/github/ulissigroup/math-methods-chemical-engineering/blob/master/lecture_notes/07a-eigenvalue-difference-equations.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
#     0 & 0 & 0 \end{array}
#   \right]\\
#   \vec{x}^{(2)} = \begin{bmatrix} -i\alpha \\
#    \alpha\end{bmatrix} \text{where $\alpha\neq0$}\\
#   \end{align}
# or, 
#  \begin{align}
#  \vec{x}^{(2)} = \begin{bmatrix} -i \\ 1 \end{bmatrix}
#  \end{align} 
# 
